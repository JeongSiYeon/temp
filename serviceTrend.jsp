...
<body
										...
										<div class="kt-portlet kt-portlet--mobile m-0">
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													...
													<div class="col-lg-2 col-md-4">
														<label>Account 선택</label>
														<select id="accountpicker-month" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4">
														<label>그룹화 기준 선택</label>
														<select id="group-month" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4 type_key-monthly-box">
														<label>Type 선택</label>
														<select id="type-month" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4 tags_key-monthly-box">
														<label>태그 키 선택</label>
														<select class="form-control kt-selectpicker" id="tags_key-month" data-live-search="true" title="Select Tag Key">
															<optgroup class="userTag_monthly text-primary" label="User" data-max-options="2">
															</optgroup>
															<optgroup class="awsTag_monthly text-primary" label="AWS" data-max-options="2">
															</optgroup>
														</select>
													</div>
												</div>
										...
										<div class="kt-portlet kt-portlet--mobile m-0">
											...
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													...
													<div class="col-lg-2 col-md-4">
														<label>Account 선택</label>
														<select id="accountpicker-day" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4">
														<label>그룹화 기준 선택</label>
														<select id="group-day" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4 type_key-daily-box">
														<label>Type 선택</label>
														<select id="type-day" class="form-control kt-selectpicker" data-width="100%"></select>
													</div>
													<div class="col-lg-2 col-md-4 tags_key-daily-box">
														<label>태그 키 선택</label>
														<select id="tags_key-day" class="form-control kt-selectpicker" data-width="100%" title="Select Tag Key">
															<optgroup class="userTag_daily text-primary" label="User" data-max-options="2">
															</optgroup>
															<optgroup class="awsTag_daily text-primary" label="AWS" data-max-options="2">
															</optgroup>
														</select>
													</div>
												</div>
	...
	<script src="assets/js/dist/billingServiceTrend.js?${buildTime}" type="text/javascript"></script>
